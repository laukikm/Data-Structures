...
class TreeOrders:
  ...
  def inOrder(self,vertex):
    ...
    if(self.left[vertex]==-1 and self.right[vertex]==-1):
        ...
        self.result=[self.key[vertex]]+self.inOrder(self.right[vertex]) #O(k), k is the size of the result
        return self.result
    elif self.right[vertex]==-1:
        
        self.result=self.inOrder(self.left[vertex])+[self.key[vertex]] #O(1) #O(k), k is the size of the result
        return self.result
    
    else:
        self.result=self.inOrder(self.left[vertex])+[self.key[vertex]]+self.inOrder(self.right[vertex]) #O(n)
        return self.result
  ...
  def preOrder(self,vertex):
    ...
    if(self.left[vertex]==-1 and self.right[vertex]==-1):
        ...
        self.result=[self.key[vertex]]+self.preOrder(self.right[vertex]) #O(k), k is the size of the result 
        
        return self.result
    elif self.right[vertex]==-1:
        self.result=[self.key[vertex]]+self.preOrder(self.left[vertex]) #O(k), k is the size of the result 
        return self.result
  
    else:
        self.result=[self.key[vertex]]+self.preOrder(self.left[vertex])+self.preOrder(self.right[vertex])
  ...
  def postOrder(self,vertex):
    ...
    if(self.left[vertex]==-1 and self.right[vertex]==-1):
        ...
        self.result=self.postOrder(self.right[vertex])+[self.key[vertex]] #O(k), k is the size of the result
        #result.extend([self.key[vertex]]) #O(1)
        return self.result
    elif self.right[vertex]==-1:
        
        self.result=self.postOrder(self.left[vertex])+[self.key[vertex]] #O(k), k is the size of the result
        #self.result.extend([self.key[vertex]]) #O(1)
        return self.result
  
    else:
        
        self.result=self.postOrder(self.left[vertex])+self.postOrder(self.right[vertex])+[self.key[vertex]]
